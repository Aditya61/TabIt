...
<div class="p-4 w-full rounded-lg shadow-md flex justify-between">
    ...
    <div class="flex flex-col gap-4 items-center">
        <!-- svelte-ignore a11y_consider_explicit_label -->
        <a class="mx-0.5" href={`/creditors/dashboard/${data?.creditor.id}/credit/${credit.id}/edit`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-cyan-800">
              <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712L4.7 15.587a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32L19.513 8.2Z" />
            </svg>
        </a>
        <!-- svelte-ignore a11y_consider_explicit_label -->
